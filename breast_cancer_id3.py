...
def get_data(data, attributes, best, val):
    ...
    new_data.remove([])
    return new_data
# This function is used to calculate the accuracy of a tree over traning & test Set.
...
#This function will build random forest with 13 trees in it
...
def build_random_Forest_decision_tree():
    ...
    with open("breast.csv") as csvfile:
    ...
    #Divide the data into Training Set(90%) and Test Set(10%)
        #random.shuffle(data)
        training_set=[]
        for i in range(0,int(len(data)*0.9)):
    ...
    #Random forest function which generate 13 trees
        print('********************************------Random Forest-------********************************')
